...
grant MAINTAIN on table public.access_invites to authenticated;
...
grant MAINTAIN on table public.access_invites to service_role;
...
grant MAINTAIN on table public.audit_finding_snoozes to authenticated;
...
grant MAINTAIN on table public.audit_finding_snoozes to service_role;
...
grant MAINTAIN on table public.audit_findings to authenticated;
...
grant MAINTAIN on table public.audit_findings to service_role;
...
grant MAINTAIN on table public.audit_runs to authenticated;
...
grant MAINTAIN on table public.audit_runs to service_role;
...
grant MAINTAIN on table public.billing_events to authenticated;
...
grant MAINTAIN on table public.billing_events to service_role;
...
grant MAINTAIN on table public.client_access to authenticated;
...
grant MAINTAIN on table public.client_access to service_role;
...
grant MAINTAIN on table public.client_cost_classifications to authenticated;
...
grant MAINTAIN on table public.client_cost_classifications to service_role;
...
grant MAINTAIN on table public.client_notes to authenticated;
...
grant MAINTAIN on table public.client_notes to service_role;
...
grant MAINTAIN on table public.client_reports to authenticated;
...
grant MAINTAIN on table public.client_reports to service_role;
...
grant MAINTAIN on table public.client_statutory_accounts to authenticated;
...
grant MAINTAIN on table public.client_statutory_accounts to service_role;
...
grant MAINTAIN on table public.client_subscriptions to authenticated;
...
grant MAINTAIN on table public.client_subscriptions to service_role;
...
grant MAINTAIN on table public.client_true_breakeven_inputs to authenticated;
...
grant MAINTAIN on table public.client_true_breakeven_inputs to service_role;
...
grant MAINTAIN on table public.client_xero_orgs to authenticated;
...
grant MAINTAIN on table public.client_xero_orgs to service_role;
...
grant MAINTAIN on table public.consolidation_group_members to authenticated;
...
grant MAINTAIN on table public.consolidation_group_members to service_role;
...
grant MAINTAIN on table public.consolidation_groups to authenticated;
...
grant MAINTAIN on table public.consolidation_groups to service_role;
...
grant MAINTAIN on table public.dashboard_card_order to authenticated;
...
grant MAINTAIN on table public.dashboard_card_order to service_role;
...
grant MAINTAIN on table public.dashboard_configs to authenticated;
...
grant MAINTAIN on table public.dashboard_configs to service_role;
...
grant MAINTAIN on table public.email_send_log to authenticated;
...
grant MAINTAIN on table public.email_send_log to service_role;
...
grant MAINTAIN on table public.email_send_state to authenticated;
...
grant MAINTAIN on table public.email_send_state to service_role;
...
grant MAINTAIN on table public.email_unsubscribe_tokens to authenticated;
...
grant MAINTAIN on table public.email_unsubscribe_tokens to service_role;
...
grant MAINTAIN on table public.firm_members to authenticated;
...
grant MAINTAIN on table public.firm_members to service_role;
...
grant MAINTAIN on table public.firm_support_access to authenticated;
...
grant MAINTAIN on table public.firm_support_access to service_role;
...
grant MAINTAIN on table public.firms to authenticated;
...
grant MAINTAIN on table public.firms to service_role;
...
grant MAINTAIN on table public.loan_consolidation_accounts to authenticated;
...
grant MAINTAIN on table public.loan_consolidation_accounts to service_role;
...
grant MAINTAIN on table public.loan_consolidation_snapshots to authenticated;
...
grant MAINTAIN on table public.loan_consolidation_snapshots to service_role;
...
grant MAINTAIN on table public.login_events to authenticated;
...
grant MAINTAIN on table public.login_events to service_role;
...
grant MAINTAIN on table public.plan_levels to authenticated;
...
grant MAINTAIN on table public.plan_levels to service_role;
...
grant MAINTAIN on table public.reconciliation_snapshots to authenticated;
...
grant MAINTAIN on table public.reconciliation_snapshots to service_role;
...
grant MAINTAIN on table public.report_cache to authenticated;
...
grant MAINTAIN on table public.report_cache to service_role;
...
grant MAINTAIN on table public.report_recipients to authenticated;
...
grant MAINTAIN on table public.report_recipients to service_role;
...
grant MAINTAIN on table public.scenario_exclusions to authenticated;
...
grant MAINTAIN on table public.scenario_exclusions to service_role;
...
grant MAINTAIN on table public.security_contact_details to authenticated;
...
grant MAINTAIN on table public.security_contact_details to service_role;
...
grant MAINTAIN on table public.security_settings to authenticated;
...
grant MAINTAIN on table public.security_settings to service_role;
...
grant MAINTAIN on table public.security_test_runs to service_role;
...
grant MAINTAIN on table public.signup_requests to authenticated;
...
grant MAINTAIN on table public.signup_requests to service_role;
...
grant MAINTAIN on table public.suppressed_emails to authenticated;
...
grant MAINTAIN on table public.suppressed_emails to service_role;
...
grant MAINTAIN on table public.tier_settings to authenticated;
...
grant MAINTAIN on table public.tier_settings to service_role;
...
grant MAINTAIN on table public.tier_widget_config to authenticated;
...
grant MAINTAIN on table public.tier_widget_config to service_role;
...
grant MAINTAIN on table public.unreconciled_lines to authenticated;
...
grant MAINTAIN on table public.unreconciled_lines to service_role;
...
grant MAINTAIN on table public.unreconciled_uploads to authenticated;
...
grant MAINTAIN on table public.unreconciled_uploads to service_role;
...
grant MAINTAIN on table public.xero_api_errors to authenticated;
...
grant MAINTAIN on table public.xero_api_errors to service_role;
...
grant MAINTAIN on table public.xero_assessment_contact to authenticated;
...
grant MAINTAIN on table public.xero_assessment_contact to service_role;
...
grant MAINTAIN on table public.xero_connections to authenticated;
...
grant MAINTAIN on table public.xero_connections to service_role;
...
grant MAINTAIN on table public.xero_oauth_states to authenticated;
...
grant MAINTAIN on table public.xero_oauth_states to service_role;
...
grant MAINTAIN on table public.xero_snapshot_runs to authenticated;
...
grant MAINTAIN on table public.xero_snapshot_runs to service_role;
...
grant MAINTAIN on table public.xero_snapshots to authenticated;
...
grant MAINTAIN on table public.xero_snapshots to service_role;
