...
grant select on public.unreconciled_uploads to authenticated;
...
create policy "Viewers can read uploads for their client" on public.unreconciled_uploads for select to authenticated using (app_private.has_client_access(auth.uid(), client_id));
create policy "manage unreconciled uploads by firm" on public.unreconciled_uploads for select to authenticated using (app_private.user_can_manage_client(auth.uid(), client_id));
