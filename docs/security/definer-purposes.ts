...
export const DEFINER_PURPOSES: Record<string, string> = {
  ...
  "public.my_client_access": "The selected-client grants the caller holds, including display relationship and label metadata.",
  ...
  "public.client_viewers": "The people who hold selected-client access, with verified email and display relationship metadata.",
  "public.client_xero_files_used": "How many Xero files a client uses.",
  "public.grant_client_access": "Gives a person selected-client access with relationship and optional display label, audited.",
  "public.set_client_access_relationship": "Classifies an existing selected-client row as Business owner or External adviser; aal2, caller-scoped and audited.",
  ...
  "app_private.has_standing_client_access": "Whether a person holds an External adviser All clients grant covering this client's organisation. READ paths only.",
  "app_private.has_client_read_access": "Whether a person may READ this client: a selected-client grant or an All clients grant. Never used by a write path.",
  ...
  "public.grant_firm_viewer_access": "Give one External adviser read-only All clients access with an optional display label. Audited.",
  ...
  "public.firm_viewers": "List one organisation's External advisers with All clients access, verified sign-in emails, and display labels.",
  "public.firm_viewer_invites": "List pending Business owner and External adviser invitations for one organisation. Never returns the token.",
