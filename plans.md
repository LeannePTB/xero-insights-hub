...
A running list of ideas and follow-ups to tackle later.

Say **"Add to plans: <your idea>"** in chat and I'll append it as a new bullet under "Backlog" below with the date.
...
- 2026-09-08 — Freight approval tool. Pull bills from Xero for nominated freight suppliers, show the client a list of unpaid ones to check, and let them tick which are approved for payment. Weekly email reminder to the client if nothing has been approved in the last 5 days.
