import { getMoneyRecommendations } from "@/lib/health.recommendations";
import type { PillarMetric } from "@/lib/health.functions";
import { AlertTriangle, Info, TrendingUp } from "lucide-react";

export function MoneyRecommendations({ metrics }: { metrics: PillarMetric[] }) {
  const recs = getMoneyRecommendations(metrics);
