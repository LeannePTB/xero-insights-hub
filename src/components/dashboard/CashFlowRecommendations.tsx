import { getCashFlowRecommendations } from "@/lib/health.recommendations";
import type { PillarMetric } from "@/lib/health.functions";
import { AlertTriangle, Info, TrendingUp } from "lucide-react";

export function CashFlowRecommendations({ metrics }: { metrics: PillarMetric[] }) {
  const recs = getCashFlowRecommendations(metrics);
