  ...
  public: {
    Tables: {
      ...
      consolidation_group_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "consolidation_group_members_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: true
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      consolidation_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "consolidation_groups_firm_id_fkey"
            columns: ["firm_id"]
            isOneToOne: false
            referencedRelation: "admin_firm_overview"
            referencedColumns: ["firm_id"]
      ...
      scenario_exclusions: {
        ...
        Relationships: [
          {
            foreignKeyName: "scenario_exclusions_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
